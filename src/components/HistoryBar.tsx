...
export function HistoryBar({ onSelect }: HistoryBarProps) {
        ...
        {!mounted || entries.length === 0 ? (
          ...
          <div className="flex gap-3 pb-1 overflow-x-auto">
            {entries.map((entry) => (
              ...
              >
                <div className="aspect-square rounded-lg overflow-hidden border bg-muted mb-1 group-hover:ring-1 group-hover:ring-primary/30 transition-all">
                  {entry.localImages[0] ? (
                    <img
